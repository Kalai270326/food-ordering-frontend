...
import './RestaNewpage.css'
function RestaNewpage() {
...
async function handleSubmit(e) {
    e.preventDefault();
    try {
      const response = await axios.post('https://food-ordering-frontend-beta.vercel.app/menu/createmenu', { menuname,
        price,
        restaurantname,
        email,
        image
